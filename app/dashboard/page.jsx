        ...
        <div className="maindash">
          <div className="cards">
            <div className="dark:bg-[#333] bg-white p-[10px] rounded-[15px] flex gap-[20px] w-[25%] justify-center items-center shadow-lg dark:shadow-lg">
              ...
              <div>
                <div className=" dark:text-[#A3AED0] text-[#A3AED0] font-bold text-[13px] ">
                  Total Patients
                </div>
                <div className="text-[#1B2559] font-bold dark:text-white">
                  300
                </div>
              </div>
              <div>
            ...
            <div className="dark:bg-[#333] bg-white p-[10px] rounded-[15px] flex gap-[20px] w-[25%] justify-center items-center shadow-lg dark:shadow-lg">
              <div>
                <div className="dark:text-[#A3AED0]  text-[#A3AED0] font-bold  text-[14px]">
                  Spent this month
                </div>
                <div className="dark:text-white text-[#1B2559] font-bold text-[18px]">
                  $682.5
                </div>
              </div>
              <div>
            ...
            <div className="dark:bg-[#333] bg-white p-[10px] rounded-[15px] flex gap-[20px] w-[25%] justify-center items-center shadow-lg dark:shadow-lg">
              ...
              <div>
                <div className="dark:text-[ #718096] text-[#A3AED0] font-bold  text-[14px]">
                  Earnings
                </div>
                <div className="dark:text-white text-[#1B2559] font-bold text-[18px]">
                  $350.5
