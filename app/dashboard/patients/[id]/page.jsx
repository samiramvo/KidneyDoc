          ...
          <form action={updatePatient} className="formIduser">
            ...
            <div className="flex flex-row w-[100%]">
              <div className="flex">
                <div className="flex flex-col mr-[30px] ">
                  <label htmlFor="name_patient" className="dark:text-[#A3AED0]">
                    Last name
                  </label>
                  <input
                    type="text"
                ...
                <div className="flex flex-col ">
                  <label
                    htmlFor="prenom_patient"
                    className="dark:text-[#A3AED0]"
                  >
                    First Name
                  </label>
                  <input
            ...
            <div className="flex flex-row w-[100%]">
              <div className="flex flex-col w-[100%] ">
                <label htmlFor="idpatient" className="dark:text-[#A3AED0]">
                  Id
                </label>
                <input
                  type="text"
            ...
            <div className=" flex flex-row w-[100%]">
              <div className="flex">
                <div className="flex flex-col mr-[30px]">
                  <label htmlFor="gender" className="dark:text-[#A3AED0]">
                    Gender
                  </label>
                  <select
                    name="gender"
                    id="gender"
                    className="w-[260px] dark:bg-[#121212] dark:opacity-[80%] dark:border-none"
                    defaultValue={patient.gender || "default"}
                  >
                ...
                <div className="flex flex-col ">
                  <label htmlFor="agepatient" className="dark:text-[#A3AED0]">
                    Age
                  </label>
                  <input
                    type="number"
            ...
            <div className="flex flex-row w-[100%]">
              <div className="flex flex-col w-[100%]">
                <label htmlFor="phone_patient" className="dark:text-[#A3AED0]">
                  Phone
                </label>
                <input
                  type="text"
            ...
            <div className="flex flex-row w-[100%]">
              <div className="flex flex-col w-[100%] ">
                <label htmlFor="addresspatient" className="dark:text-[#A3AED0]">
                  Address
                </label>
                <textarea
                  type="text"
